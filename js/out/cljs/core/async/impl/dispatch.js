...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14489 = 0;while(true){
var m_14490 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14490 == null))
{} else
{m_14490.call(null);
if((count_14489 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14491 = (count_14489 + 1);
count_14489 = G__14491;
continue;
}
} else
{}
