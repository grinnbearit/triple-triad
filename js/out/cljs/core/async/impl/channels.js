...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14495 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14495 = (function (val,box,meta14496){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14495.cljs$lang$type = true;
cljs.core.async.impl.channels.t14495.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14495";
cljs.core.async.impl.channels.t14495.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/t14495");
});
cljs.core.async.impl.channels.t14495.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14495.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14497){var self__ = this;
var _14497__$1 = this;return self__.meta14496;
});
cljs.core.async.impl.channels.t14495.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14497,meta14496__$1){var self__ = this;
var _14497__$1 = this;return (new cljs.core.async.impl.channels.t14495(self__.val,self__.box,meta14496__$1));
});
cljs.core.async.impl.channels.__GT_t14495 = (function __GT_t14495(val__$1,box__$1,meta14496){return (new cljs.core.async.impl.channels.t14495(val__$1,box__$1,meta14496));
});
}
return (new cljs.core.async.impl.channels.t14495(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14498 = self__.takes.pop();if((taker_14498 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14498))
{var take_cb_14499 = cljs.core.async.impl.protocols.commit.call(null,taker_14498);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14499,taker_14498){
return (function (){return take_cb_14499.call(null,null);
});})(take_cb_14499,taker_14498))
);
} else
{}
{
