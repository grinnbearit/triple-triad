...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14454 = 0;while(true){
if((i_14454 < arr.length))
{(arr[i_14454] = null);
{
...
{var i_14461 = (self__.level + 1);while(true){
if((i_14461 <= (new_level + 1)))
{(update[i_14461] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14463 = 0;while(true){
if((i_14463 <= self__.level))
{var links_14464 = (update[i_14463]).forward;if(((links_14464[i_14463]) === x__$1))
{(links_14464[i_14463] = (x__$1.forward[i_14463]));
{
var G__14465 = (i_14463 + 1);
i_14463 = G__14465;
continue;
}
} else
{{
var G__14466 = (i_14463 + 1);
i_14463 = G__14466;
continue;
}
}
