...
{{
var G__11741 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11741;
continue;
}
} else
...
{var pred__11745 = cljs.core._EQ_;var expr__11746 = limit;if(cljs.core.truth_(pred__11745.call(null,1,expr__11746)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11745.call(null,2,expr__11746)))
...
var G__11748 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11749 = (limit__$1 - 1);
var G__11750 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11748;
limit__$1 = G__11749;
parts = G__11750;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11752 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11752))
{var replacement_11753 = temp__4090__auto___11752;buffer.append([cljs.core.str(replacement_11753)].join(''));
} else
{buffer.append(ch);
}
{
var G__11754 = (index + 1);
index = G__11754;
continue;
}
}
